...
function NewHomeStack(props) {
  return (
    <Stack.Navigator initialRouteName="NewHome" mode="card" headerMode="screen">
      <Stack.Screen
        name="NewHome"
        component={NewHome}
        options={{
...
function TrendingStack(props) {
  return (
    <Stack.Navigator initialRouteName="Trending" mode="card" headerMode="screen">
      <Stack.Screen
        name="Trending"
        component={Trending}
        options={{
...
function AppStack(props) {
  return (
    ...
    >
      ...
      <Drawer.Screen name="NewHome" component={NewHomeStack} />
       <Drawer.Screen name="Trending" component={TrendingStack} />
    </Drawer.Navigator>
  );
}
